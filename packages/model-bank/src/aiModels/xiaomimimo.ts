...
const xiaomimimoChatModels: AIChatModelCard[] = [
  ...
  },
  {
    ...
    description:
      'MiMo-V2.5 is a major step forward in agentic capability and multimodal understanding. It reasons seamlessly across modalities, surpasses MiMo-V2-Pro in agentic performance, and supports up to 1 million tokens of context.',
    displayName: 'MiMo-V2.5',
    enabled: false,
    id: 'mimo-v2.5',
    maxOutput: 131_072,
  ...
  },
  {
    ...
    contextWindowTokens: 1_048_576,
    description:
      'MiMo-V2.5-Pro delivers significant improvements over MiMo-V2-Pro in general agentic capabilities, complex software engineering, and long-horizon tasks spanning more than a thousand tool calls.',
    displayName: 'MiMo-V2.5 Pro',
    enabled: true,
    id: 'mimo-v2.5-pro',
    maxOutput: 131_072,
