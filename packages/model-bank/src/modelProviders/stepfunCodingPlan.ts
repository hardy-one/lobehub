...
const StepFunCodingPlan: ModelProviderCard = {
  chatModels: [],
  checkModel: 'step-3.7-flash',
  description:
    'Step Plan provides access to StepFun models including Step 3.7 Flash and Step 3.5 Flash for coding tasks via a fixed-fee subscription.',
